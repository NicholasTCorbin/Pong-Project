----------------------------------------------------------------------------------
-- Engineer: Nick Corbin Jeffrey Liu
   ...
   begin
      if rising_edge(clk60) then
         if(resetInit = '0') then
            ...
            -- use the gen counter to randomize the balls start
            ...
            upDown <= count_so(7);
            leftRight <= count_so(6);

         else -- we in the sim
              -- this makes the code more repeatable and predictable
            ballX <= 320;
            ballY <= 240;
            ballSpeedX <=  5;
            ballSpeedY <=  5;
         ...
         if(resetInit = '0') then
            if(leftRight = '1') then
               ...
               and (ballY < (leftPaddleY + PADDLE_HEIGHT))) then
                  ...
                  -- determines the bounce off angle
                  if( x < 8) then
                     ballSpeedX <= 2;
                     ballSpeedY <= 7;
                     upDown <= '1';
